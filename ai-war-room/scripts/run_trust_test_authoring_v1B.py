...
prompt_path = Path("ai-war-room/outputs/07_trust_tests/trust_backend_test_authoring_prompt_run01B.md")
json_path   = Path("ai-war-room/outputs/07_trust_tests/trust_backend_test_authoring_run01B.response.json")
out_path    = Path("ai-war-room/outputs/07_trust_tests/trust_backend_test_authoring_run01B.md")
