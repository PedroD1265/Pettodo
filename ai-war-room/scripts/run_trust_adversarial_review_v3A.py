...
prompt_path = Path("ai-war-room/outputs/06_trust_adversarial/trust_backend_adversarial_review_prompt_run03A.md")
json_path   = Path("ai-war-room/outputs/06_trust_adversarial/trust_backend_adversarial_review_run03A.response.json")
out_path    = Path("ai-war-room/outputs/06_trust_adversarial/trust_backend_adversarial_review_run03A.md")
