# PETTODO Trust Backend Adversarial Review v3A
...
## Objetivo
Identificar rutas de explotación, fugas público/privado, corrupción de estado, omisiones de audit log y paths de regresión antes de pasar a test authoring.
