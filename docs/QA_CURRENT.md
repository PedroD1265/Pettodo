...
**[confirmed]**
- that pet profile update/delete flows are fully end-to-end validated through the UI (blocked by pet-profile routing bug)
...
| Update/Delete persistence | Partially validated | Verified via code pattern; blocked by UI routing bug in front-end |
...
### Blockers
**[confirmed]**
- pet update/delete UX testing blocked in integration mode (routing bug points to static Luna profile instead of dynamic ID)
...
**[confirmed]**
- full pet update/delete UX flows in integration mode (blocked by UI routing bug)
...
**[confirmed]**
- unblock pet profile dynamic routing to enable E2E UX tests for Update/Delete
- harden persistent real animal records (Update/Delete real flows)
- real case creation
